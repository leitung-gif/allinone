    ...
    <section class="page-hero">
        <div class="page-padding">
            <div class="container fade-up" style="text-align: center;">
                ...
                <h1><em>404</em></h1>
                <p style="max-width: 500px; margin: 0 auto;">Die gesuchte Seite existiert nicht oder wurde verschoben. Kehren Sie zur Startseite zurück oder entdecken Sie meine Behandlungen.</p>
